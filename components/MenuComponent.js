    ...
    <View style={{ padding: 10 }}>
      ...
      >
        <Pressable onPress={() => navigation.navigate("Pizza")}>
          <Image
            style={{ width: 250, height: 160, borderRadius: 10,alignItems: 'center', justifyContent: 'center',marginBottom: '2%',}}
            source={{
              uri: "https://i0.wp.com/nationalfoods.org/wp-content/uploads/2018/11/National-Dish-of-Italy-Pizza.jpg?fit=1140%2C500&ssl=1",
            }}
          />
          <Text style={{textAlign: "center",fontSize:17,color:"white",marginTop:0}}>Cardápio</Text>
        </Pressable>
      </Pressable>
    </View>
  );
